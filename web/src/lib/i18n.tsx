...
const en = {
  ...
  'set.download.uaDesc': 'Presets: Chrome / Firefox / Edge / Safari',
  ...
  'set.sec.jsonrpc': 'aria2-compatible RPC',
  'set.sec.jsonrpcDesc': '/jsonrpc · addUri / getGlobalStat / multicall',
  'set.sec.takeover': 'Script takeover endpoint',
  'set.sec.takeoverDesc': '/download · userscripts / browser extension',
...
const zh: Record<I18nKey, string> = {
  ...
  'set.download.uaDesc': '预设：Chrome / Firefox / Edge / Safari',
  ...
  'set.sec.jsonrpc': 'aria2 兼容 RPC',
  'set.sec.jsonrpcDesc': '/jsonrpc · addUri / getGlobalStat / multicall',
  'set.sec.takeover': '脚本接管入口',
  'set.sec.takeoverDesc': '/download · 油猴脚本 / 浏览器扩展',
